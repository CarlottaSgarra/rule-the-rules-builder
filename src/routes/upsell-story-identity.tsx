...
import { CalendarDays, Check, IdCard, ListX, Wand2 } from "lucide-react";
...
export const Route = createFileRoute("/upsell-story-identity")({
  head: () => ({
    meta: [
      { title: "Rule The Rules 2026: il prossimo passo dopo Story Identity" },
      {
        name: "description",
        content:
          "Hai appena acquistato Story Identity: scopri Rule The Rules 2026, le 3 serate live con Carlotta Sgarra per lavorare ancora più a fondo sulla tua identità e sulla tua comunicazione.",
      },
      { name: "robots", content: "noindex" },
    ],
  }),
  component: UpsellStoryIdentity,
});
    ...
    <div className="bg-background">
      ...
      <section className="bg-background px-4 py-14 sm:px-8 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            >
              Hai appena sbloccato Story Identity
            </span>
            <h1 className="mt-4 text-3xl sm:text-4xl">Aspetta un secondo prima di continuare</h1>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-foreground/75 sm:text-lg">
              Con Story Identity hai appena fatto il primo passo per costruire la tua identità. Ora
              voglio proporti il passo successivo:{" "}
              <strong className="font-semibold text-foreground">Rule The Rules</strong>, il mio
              evento live dal 5 al 7 ottobre, per lavorare ancora più a fondo sulla tua identità e
              sulla tua comunicazione, insieme a me, in diretta.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--secondary)" }}>
        <img
          ...
          loading="lazy"
          className="pointer-events-none absolute inset-0 h-[520px] w-full object-cover object-[25%_30%] sm:h-full sm:object-[25%_42%]"
        />
        <div
